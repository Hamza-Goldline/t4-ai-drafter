...
let CREDENTIALS_PATH = path.join(process.cwd(), 'credentials.json');

function setPaths(baseDir) {
    TOKEN_PATH = path.join(baseDir, 'token.json');
    CREDENTIALS_PATH = path.join(baseDir, 'credentials.json');
}
